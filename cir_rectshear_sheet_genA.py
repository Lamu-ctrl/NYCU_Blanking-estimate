    ...
    for k1 in range(columns):
        ...
        for k2 in range(2):
            ...
            # end if  ## circle
                ...
                rect_W = random.randint(500, 900) # width
                rect_H = random.randint(500, 900) # hight
                ...
                hole_W = random.randint(100, 150)
                hole_H = random.randint(100, 150)
                hole_Xgap = hole_W * 0.5 + random.randint(20, 30)
                hole_Ygap = hole_W * 0.72 + hole_H * 0.72 + random.randint(10, 20)
                if hole_Ygap <= 0:
                    hole_Ygap = random.randint(5, 10)
...
if __name__ == '__main__':
    ...
    print("Cir_RectShear_sheetA\n")
    
    
    sheet_num = 25
    for k in range(sheet_num):
    
        path = 'Cir_RectShear_Training_sheetA'
