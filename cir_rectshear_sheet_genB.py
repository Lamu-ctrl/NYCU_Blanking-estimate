    ...
    for k1 in range(columns):
        ...
        for k2 in range(rows):
            ...
            # end if  ## circle
                ...
                rect_W = random.randint(400, 600) # width
                rect_H = random.randint(400, 600) # hight
                ...
                hole_W = random.randint(60, 120)
                hole_H = random.randint(60, 120)
...
if __name__ == '__main__':
    ...
    print("Cir_RectShear_sheetB\n")
    
    
    sheet_num = 25
    for k in range(sheet_num):
    
        path = 'Cir_RectShear_Training_sheetB'
